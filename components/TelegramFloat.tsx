...
export const TelegramFloat = () => {
  return (
    <a
      ...
      target='_blank'
      rel='noreferrer'
      className='fixed bottom-20 right-6 md:bottom-24 md:right-10 z-[50] group'
    ...
    >
      <div className='relative'>
        ...
        {/* Button */}
        <div className='relative bg-[#229ED9] text-white p-3.5 md:p-4 rounded-full shadow-lg hover:shadow-xl hover:scale-110 active:scale-95 transition-all duration-300 ease-out flex items-center justify-center'>
