...
import { ArrowDown, ArrowLeftRight, ChevronLeft, ChevronRight, Smartphone } from 'lucide-react';
import type { TradeInDeviceView, TradeInTargetColor, TradeInTargetLine } from '@/lib/api';
